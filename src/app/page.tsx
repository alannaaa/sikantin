export default function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col bg-[#fcf5c1]">
      ...
      {/* 3 stars */}
      <div className="bg-[#FFFCE4] pt-8 md:pt-24 gap-[30px] md:gap-[120px] flex-col justify-center items-center inline-flex">
        ...
        <div className="w-full grid grid-cols-2 justify-items-center">
          <div className="pl-10">
            <img className="w-[640px]" src="assets/images/siap.png" />
          </div>
      ...
      <div className="mx-8 md:px-[74px] md:py-[115px] py-6 flex-col justify-start items-center md:gap-[95px] gap-4 inline-flex">
        <div className="text-center text-black text-2xl md:text-6xl font-semibold font-['Plus Jakarta Sans']">Menu Populer di SiKantin</div>
      ...
      {/* Testimonial */}
      <div className="bg-[#FFFCE4] md:px-[74px] md:py-[200px] py-6 flex-col justify-start items-center md:gap-[95px] gap-4 inline-flex">
        <div className="gap-3 flex flex-col w-full md:px-28">
          <div className="text-gray-500 font-semibold text-xl">TESTIMONIAL</div>
          <div className="text-black font-semibold text-2xl md:text-5xl">Apa kata mereka</div>
        </div>

        <div className="grid md:grid-cols-2 md:gap-16 px-28">
          <div className="flex gap-4">
            <img src="assets/images/face1.jpg" className="rounded-2xl w-[176px] h-[176px]" />
            <div className="flex flex-col gap-2">
              <div className="text-black">Verbi Meliala <span className="px-2 text-[#D1D5DB]">|</span> <span className="text-[#ffd603] font-semibold">Mahasiswi, FEB UI</span></div>
              <img src="assets/images/stars.png" className="h-[20px] w-[116px]" />
              <div className="text-black">Akhirnya nggak perlu antre lama lagi di kantin! Bisa lihat status pesanan langsung dari HP, jadi lebih praktis dan hemat waktu. Fiturnya gampang banget dipakai.</div>
            </div>
          </div>

          <div className="flex gap-4">
            <img src="assets/images/face2.jpg" className="rounded-2xl w-[176px] h-[176px]" />
            <div className="flex flex-col gap-2">
              <div className="text-black">Dimas Prayogi <span className="px-2 text-[#D1D5DB]">|</span> <span className="text-[#ffd603] font-semibold">Mahasiswa, FT UI</span></div>
              <img src="assets/images/stars.png" className="h-[20px] w-[116px]" />
              <div className="text-black">Sekarang nyari makanan di kantin jadi lebih seru. Bisa lihat menu lengkap sama harga sebelum pesan, jadi nggak bingung pas sampai kios. Aplikasinya simpel, bikin pengalaman makan di kampus jauh lebih enak.</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
                <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                    <div className="text-4xl text-black flex gap-4 font-bold items-center"><img src="assets/images/StarNavbar.svg"/>SiKantin</div>
                    <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Jelajahi pilihan makanan, cek menu, dan pesan makanan dengan mudah dari seluruh kantin Universitas Indonesia.</p>
                    <a href="javascript:;"  className="py-2.5 px-5 h-9 block w-fit bg-[#ffd603] rounded-full shadow-sm text-xs text-black mx-auto transition-all  duration-500 hover:bg-[#FFFCE4] lg:mx-0">
                ...
                <div className="lg:mx-auto text-left ">
                    ...
                    <ul className="text-sm  transition-all duration-500">
                        <li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900">Komunitas</a></li>
                        <li className="mb-6"><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">Fitur</a></li>
                        <li><a href="javascript:;"  className=" text-gray-600 hover:text-gray-900">FAQ</a></li>
                    </ul>
                </div>
                <div className="lg:mx-auto text-left ">
            ...
            <div className="py-7 border-t border-gray-200">
                <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                    <span className="text-sm text-gray-500 ">©<a className="pl-2" href="https://sikantin.vercel.app/">SiKantin</a> 2024, All rights reserved.</span>
